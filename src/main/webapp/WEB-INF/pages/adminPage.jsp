        ...
        <div class="panel-body">
            ...
            <form:form class="form-horizontal" method="post"
                ...
                <spring:bind path="sshUserPassword">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <label class="col-sm-2 control-label">ssh User/Password</label>
                        <div class="col-sm-9">
                ...
                <spring:bind path="rootPassword">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <label class="col-sm-2 control-label">Root Password</label>
                        <div class="col-sm-9">
                ...
                <spring:bind path="amsVersion">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <label class="col-sm-2 control-label">AMS Version</label>
                        <div class="col-sm-9">
                ...
                <spring:bind path="isAvailable">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <label class="col-sm-2 control-label">Active</label>
                        <div class="col-sm-9">
                            <div class="checkbox">
                                <label>
                                    <form:checkbox path="isAvailable" id="isAvailable" value="1" />
                                </label>
                                <form:errors path="isAvailable" class="control-label" />
                            </div>
                        </div>
                    </div>
                </spring:bind>
            <div class="col-sm-10">
                ...
                <button type="submit" class="btn-lg btn-primary pull-right">Add server</button>
